...
<html lang="en" dir="ltr">
   <head>
      ...
      @include('layouts.compact_dark.css')
      @yield('style')
   </head>
   <body class="dark-only" main-theme-layout="ltr">
      ...
      <div class="page-wrapper compact-wrapper" id="pageWrapper">
         <!-- Page Header Start-->
         @include('layouts.compact_dark.header')
         <!-- Page Header Ends -->
         <!-- Page Body Start-->
         <div class="page-body-wrapper sidebar-icon">
            <nav-menus></nav-menus>
            @include('layouts.compact_dark.sidebar')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('layouts.compact_dark.footer')
         </div>
      </div>
      @include('layouts.compact_dark.script')
   </body>
</html>