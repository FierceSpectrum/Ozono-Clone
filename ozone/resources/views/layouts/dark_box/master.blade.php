...
<html lang="en" dir="ltr">
   ...
   <body class="dark-only" main-theme-layout="box-layout">
      ...
      <div class="page-wrapper compact-wrapper" id="pageWrapper">
         <!-- Page Header Start-->
         @include('layouts.dark_box.header')
         <!-- Page Header Ends -->
         <!-- Page Body Start-->
         <div class="page-body-wrapper sidebar-icon">
            <nav-menus></nav-menus>
            @include('layouts.dark_box.sidebar')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('layouts.dark_box.footer')
         </div>
      </div>
      @include('layouts.dark_box.script')
   </body>
</html>