...
<html lang="en" dir="rtl">
   ...
   <body class="dark-only" main-theme-layout="rtl">
      ...
      <div class="page-wrapper compact-wrapper" id="pageWrapper">
         <!-- Page Header Start-->
         @include('layouts.dark_rtl.header')
         <!-- Page Header Ends -->
         <!-- Page Body Start-->
         <div class="page-body-wrapper sidebar-icon">
            <nav-menus></nav-menus>
            @include('layouts.dark_rtl.sidebar')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('layouts.dark_rtl.footer')
         </div>
      </div>
      @include('layouts.dark_rtl.script')
   </body>
</html>