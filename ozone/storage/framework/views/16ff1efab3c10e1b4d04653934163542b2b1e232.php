                  ...
                  <ul class="nav-submenu menu-content" style="display: <?php echo e(request()->route()->getPrefix() == '/starter-kit' ? 'block;' : 'none'); ?>">
                     <li>
                        ...
                        <ul class="nav-sub-childmenu submenu-content" style="display: <?php echo e(in_array(Route::currentRouteName(), ['layout-light', 'layout-dark']) ? 'block' : 'none'); ?>;">
                           ...
                           <li><a href="<?php echo e(route('layout-dark')); ?>" class="<?php echo e(Route::currentRouteName()=='layout-dark' ? 'active' : ''); ?>" style=" <?php echo e(Route::currentRouteName()=='layout-dark' ? 'font-weight: bold;' : ''); ?>"><b> Layout Dark</b></a></li>
                        </ul>
                     </li>
                     <li>
...
</header><?php /**PATH /home/prajit/Downloads/wetransfer_poco-zip_2022-07-16_0710/xolo/Xolo_Starter_Kit/resources/views/layouts/dark/sidebar.blade.php ENDPATH**/ ?>