               ...
               <li class="dropdown">
                  ...
                  <ul class="nav-submenu menu-content" style="display: <?php echo e(request()->route()->getPrefix() == '/starter-kit' ? 'block;' : 'none'); ?>">
                     ...
                     <li>
                        ...
                        <ul class="nav-sub-childmenu submenu-content" style="display: <?php echo e(in_array(Route::currentRouteName(), ['layout-box', 'layout-rtl', 'compact-layout', 'vertical-layout', 'dark-rtl-layout', 'vertical-rtl-layout', 'compact-rtl-layout', 'dark-box-layout', 'vertical-box-layout', 'compact-dark-layout']) ? 'none' : 'none'); ?>;">
...
</header><?php /**PATH /home/ekta/Documents/0 - Themeforest - Themes/Xolo Theme/Xolo_Starter_Kit/resources/views/layouts/vertical/sidebar.blade.php ENDPATH**/ ?>