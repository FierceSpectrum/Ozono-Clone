      ...
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown"><i data-feather="message-circle"></i>
          <ul class="chat-dropdown onhover-show-div p-t-20 p-b-20">
            <li>
              <div class="media"><img class="img-fluid rounded-circle mr-3" src="<?php echo e(asset('assets/images/user/2.jpg')); ?>" alt="">
            ...
            <li>
              <div class="media"><img class="img-fluid rounded-circle mr-3" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="">
            ...
            <li>
              <div class="media"><img class="img-fluid rounded-circle mr-3" src="<?php echo e(asset('assets/images/user/4.jpg')); ?>" alt="">
        ...
        <li class="onhover-dropdown px-0"><span class="media user-header"><img class="mr-2 rounded-circle img-35" src="<?php echo e(asset('assets/images/dashboard/user.png')); ?>" alt=""><span class="media-body"><span class="f-12 f-w-600">Elana Saint</span><span class="d-block">Admin</span></span></span>
...
</div><?php /**PATH /home/prajit/Downloads/wetransfer_poco-zip_2022-07-16_0710/xolo/Xolo_Starter_Kit/resources/views/layouts/light/header.blade.php ENDPATH**/ ?>